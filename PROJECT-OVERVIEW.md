...
- ✅ 74 checks reading the source and 62 checks driving a real browser, on every push
...
- **Automated verification, in two layers.** 74 checks reading the files (structure, images, SEO,
  structured data, form integrity, repo-wide secret scan) and 62 browser checks that
